...
ParticleEngine.prototype.initialize = function()
{
	...
	for (var i = 0; i < this.particleCount; i++)
	{
		...
		this.particleGeometry.addAttribute('customVisible',   new THREE.BufferAttribute(this.particleArray[i].alive));
		this.particleGeometry.addAttribute('customColor',   new THREE.BufferAttribute(this.particleArray[i].color));
		this.particleGeometry.addAttribute('customOpacity',   new THREE.BufferAttribute(this.particleArray[i].opacity));
		this.particleGeometry.addAttribute('customSize',   new THREE.BufferAttribute(this.particleArray[i].size));
		this.particleGeometry.addAttribute('customAngle',   new THREE.BufferAttribute(this.particleArray[i].angle));
